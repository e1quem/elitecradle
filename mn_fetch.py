...
def is_correct_profile(soup, target_name):
    ...
    is_politician = any(kw in page_text for kw in ["ministre", "politique", "gouvernement", "femme politique", "homme politique"])
...
def get_wikipedia_soup(name):
    ...
    variations = [base_formatted, f"{base_formatted}_(homme_politique)", f"{base_formatted}_(femme_politique)", f"{base_formatted}_(personalité_publique)"]
...
if __name__ == "__main__":
    ...
    # Load data
    input_file = "/Users/eyquem/Desktop/LeadersMap/sources/ministres_list.csv"
    ...
    output_file = "/Users/eyquem/Desktop/LeadersMap/outputs/mn_geo_missing.csv"
