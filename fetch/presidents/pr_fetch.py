...
with open('/Users/eyquem/Desktop/LeadersMap/fetch/presidents/src/presidents_list.txt', 'r', encoding='utf-8') as f:
...
df.to_csv("/Users/eyquem/Desktop/LeadersMap/fetch/presidents/interim/presidents_data.csv", index=False)