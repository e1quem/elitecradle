...
with open("/Users/eyquem/Desktop/LeadersMap/fetch/deputees/raw/departments_raw.txt", "r", encoding="utf-8") as f:
    content = f.read()
...
# Saving as CSV
output_path = "/Users/eyquem/Desktop/LeadersMap/fetch/deputees/interim/dp_geo_enrich.csv"
