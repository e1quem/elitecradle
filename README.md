...
Before manual cleaning, ```interim/merged_raw.csv``` contains 7745 individuals. We delete individuals born before 1870 and those born in foreign cities with french homonyms, we correct names of municipalities that have ceased to exist, etc. We are left with an exploitable dataset of 6500 individuals structured in the following way:
